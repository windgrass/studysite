...
if(isset($_GET['action'])) {
    ...
    <tr>
      <td colspan="2" style="background-color: #4f5259; color: #FFFFFF">'.$_language->module['add_contact'].'</td>
    </tr>
      <tr>
    ...
    <table width="100%" border="0" cellspacing="1" cellpadding="3" class="table table-hover">
    <tr>
      <td colspan="2" style="background-color: #4f5259; color: #FFFFFF">'.$_language->module['edit_contact'].'</td>
    </tr>
      <tr>
        <td width="15%"><b>'.$_language->module['contact_name'].'</b></td>
