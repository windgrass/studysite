...
<tr>
      <td colspan="2" style="background-color: #4f5259; color: #FFFFFF">'.$_language->module['add_country'].'</td>
    </tr>
    <tr>
...
elseif($action=="edit") {
  ...
  <table width="100%" border="0" cellspacing="1" cellpadding="3" class="table table-hover">
<tr>
      <td colspan="2" style="background-color: #4f5259; color: #FFFFFF">'.$_language->module['edit_country'].'</td>
    </tr>
    <tr>
  ...
  <table width="100%" border="0" cellspacing="1" cellpadding="3" class="table table-hover">
    ...
    while($flags = mysql_fetch_array($ds)) {
      ...
      echo'<tr>
        ...
        <td class="'.$td.'" >'.getinput($flags['short']).'</td>
        <td class="'.$td.'" ><input type="button" onclick="MM_goToURL(\'parent\',\'admincenter.php?site=countries&amp;action=edit&amp;countryID='.$flags['countryID'].'\');return document.MM_returnValue" value="'.$_language->module['edit'].'" />
