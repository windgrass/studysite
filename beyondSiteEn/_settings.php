...
mysqli_connect($host, $user, $pwd, $db) or system_error('ERROR: Can not connect to MySQL-Server');
//mysqli::select_db($db) or system_error('ERROR: Can not connect to database "'.$db.'"');
...
function globalskiller() {		// kills all non-system variables
  ...
  $global = array('mysqli', 'GLOBALS', '_POST', '_GET', '_COOKIE', '_FILES', '_SERVER', '_ENV',  '_REQUEST', '_SESSION');
...
if($site!="search" or action!="search") {
	$request=strtolower(urldecode($server_uri));
...
function system_error($text,$system=1) {
  ...
  <head>
	  ...
	  <title>Any problem? Get some help with the creator of this website: www.nuno-silva.pt</title>
	  <link href="https://fonts.googleapis.com/css?family=Open+Sans:400,700" rel="stylesheet" type="text/css">
  </head>
  <body bgcolor="#d1d1d1" style="font-family: Open Sans">
  <center><font style="font-size: 20px">Any problem? <br \>Get some help with the creator of this website</font></center>
  <br \>
  <center><table border="0" cellpadding="1" cellspacing="1" bgcolor="#1ABC9C">
    <tr>
      <td></td>
    </tr>
    <tr bgcolor="#1ABC9C">
      <td><center><div style="color:#333333; padding:5px;">'.$info.'<br /><font color="#FFFFFF" style="font-size: 14px;">'.$text.'</font><br />&nbsp;</div></center></td>
    </tr>
    <tr bgcolor="">
      <td><center><div style="color:#333333;padding:5px; font-size: 14px;">For support visit <br \><a style="color: #FFFFFF" href="http://www.nuno-silva.pt" target="_blank">www.nuno-silva.pt</a></center></div></td>
    </tr>
  </table>
  </center>
  </body>
...
$new_chmod = 0666;
$allow_usermovies=0; // 1= users are allowed to add videos; 0= no usermovies allowed
$admin_activation=0; // 1= admin activasion enabled; 2= admin activasion disabled
