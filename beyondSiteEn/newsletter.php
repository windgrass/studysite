...
if($action=="save") {
	...
	if(!validate_email($email)) redirect('../../index.php', $_language->module['email_not_valid'],3);
	else {
		...
		if(!mysql_num_rows($ergebnis)) {
			...
			redirect('index.php?site=tablet', $_language->module['thank_you_for_registration'],3);
		}
		else redirect('index.php?site=tablet', $_language->module['you_are_already_registered'],3);
	}
}
