...
echo '<h1>'.$_language->module['visitor_stats_overall'].'</h1>';
...
echo '<h1>'.$_language->module['visitor_stats_graphics'].'</h1>';
...
<h1 id="last_days_h2"><?php echo $_language->module['last']; ?> <?php echo $count_days; ?> <?php echo $_language->module['days']; ?></h1>
<img id="last_days" src="visitor_statistic_image.php?last=days&amp;count=<?php echo $count_days; ?>" alt="" />
<h1 id="last_months_h2"><?php echo $_language->module['last']; ?> <?php echo $count_months; ?> <?php echo $_language->module['months']; ?></h1>
